...
const userSchema = new mongoose.Schema({
    ...
    role: { type: String, enum: ['admin', 'sostenedor', 'teacher', 'student', 'apoderado', 'psicologo', 'orientador', 'asistente_aula', 'manipulador_alimento', 'bibliotecario', 'secretario', 'paradocente'], required: true },
